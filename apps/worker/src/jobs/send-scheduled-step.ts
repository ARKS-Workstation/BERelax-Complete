...
export function scheduledStepRuntimeFor(sql: Sql): ScheduledStepRuntime {
  ...
  const send: SendContext = {
    ...
    gate: {
      ...
      // The same three fail-closed evaluators B-LIFE-02's route wires, for the same reason: the consent,
      // suppression and frequency stores are C-CRM-03, C-CRM-04 and C-AUTO-03. A reminder is
